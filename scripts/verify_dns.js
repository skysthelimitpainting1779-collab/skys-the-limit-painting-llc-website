...
async function verifyDNS() {
  ...
  try {
    ...
    try {
      ...
      console.log(`Apex resolution returned: ${e.message}. Attempting standard A-record lookup...`);
    ...
    try {
      ...
      console.log(`WWW CNAME resolution returned: ${e.message}. Attempting A-record lookup...`);
      const resolveA = promisify(dns.resolve4);
