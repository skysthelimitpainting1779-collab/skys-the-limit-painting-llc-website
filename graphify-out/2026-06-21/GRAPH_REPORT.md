# Graph Report - C:\Users\Johnny Cage\DEV\skysthelimit-collab  (2026-06-21)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 4042 nodes · 5057 edges · 545 communities (326 shown, 219 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 130 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d0c232f`
...
5. `lucide-react` - 31 edges
6. `React Native Skills` - 26 edges
7. `canonicalizeRoute()` - 25 edges
8. `recText()` - 24 edges
9. `renderReport()` - 24 edges
10. `main()` - 24 edges

## Surprising Connections (you probably didn't know these)
- `PROJECT.md: Visual Redesign & Functionality Audit` --references--> `CLAUDE.md Developer & Agent Reference Guide`  [INFERRED]
  PROJECT.md → CLAUDE.md
- `Hoist Intl formatter creation` --conceptually_related_to--> `Hoist RegExp Creation`  [INFERRED]
  .agents/skills/vercel-react-native-skills/rules/js-hoist-intl.md → .agents/skills/vercel-react-best-practices/rules/js-hoist-regexp.md
- `Design Principles` --conceptually_related_to--> `Visual Theme`  [INFERRED]
  PRODUCT.md → DESIGN.md
- `Design Principles` --conceptually_related_to--> `Layout & Radius`  [INFERRED]
  PRODUCT.md → DESIGN.md
- `test_out.txt: E2E test failures (App.tsx routing)` --references--> `PROJECT.md: Visual Redesign & Functionality Audit`  [INFERRED]
  test_out.txt → PROJECT.md

## Import Cycles
- None detected.

## Communities (545 total, 219 thin omitted)
...
Cohesion: 0.07
Nodes (59): affectedFiles(), appliesAlsoEntry(), cacheLifeIntent(), dedupEditTarget(), dedupeRecommendations(), dedupIntent(), firstAffectedFile(), fixShape() (+51 more)
...
Cohesion: 0.08
Nodes (43): deriveProjectFacts(), asArray(), assertValidObservations(), buildFinalReportMessage(), candidateForDisplay(), compactFinalText(), displayCandidate(), displayCandidateObject() (+35 more)

### Community 5 - "SEO and Schema"
Cohesion: 0.04
Nodes (46): 1. Start with a Hypothesis, 2. Test One Thing, 3. Statistical Rigor, 4. Measure What Matters, A/B Test Setup, Analysis, Analysis Checklist, Analyzing Results (+38 more)

### Community 6 - "Vercel Optimize"
Cohesion: 0.04
Nodes (46): Animation Timing, Backdrop-Blur Workaround, Card Expand/Collapse with `startTransition`, Common Mistakes, Cross-Fade Without Remount, CSS Animation Recipes, Directional Navigation, Exclude Elements with `useOptimistic` (+38 more)
...
Cohesion: 0.05
Nodes (40): Sections, 1. Component Architecture (architecture), 2. State Management (state), 3. Implementation Patterns (patterns), 4. React 19 APIs (react19), 1. Component Architecture (HIGH), 4. React 19 APIs (MEDIUM), Full Compiled Document (+32 more)

### Community 9 - "React Best Practices"
Cohesion: 0.13
Nodes (11): FadeIn(), FadeInProps, BeforeAfterSliderProps, PageTransition(), PageTransitionProps, ResponsiveImage(), ResponsiveImageProps, Active Docs (+3 more)

### Community 10 - "Vercel Optimize"
Cohesion: 0.06
Nodes (28): budgetOptions, contactMethods, LeadFormProps, projectOptions, propertyOptions, Status, timelineOptions, Testimonial (+20 more)

### Community 11 - "Vercel Optimize"
Cohesion: 0.05
Nodes (39): 1. Track for Decisions, Not Data, 2. Start with the Questions, 3. Name Things Consistently, 4. Maintain Data Quality, Analytics Tracking, Best Practices, Common Issues, Considerations (+31 more)
...
### Community 16 - "Vercel Optimize"
Cohesion: 0.06
Nodes (33): 1. Current Churn Situation, 2. Billing & Platform, 3. Product & Usage Data, 4. Constraints, Before Starting, Billing Providers (Dunning), Cancel Flow A/B Tests, Cancel Flow Design (+25 more)

### Community 17 - "UI Components"
Cohesion: 0.06
Nodes (33): 1. Audience Overlap Analysis, 1. Shared Audience Moments, 2. Combined Value Propositions, 2. Partner Scoring Criteria, 3. Unique Assets Each Brings, 3. Where to Find Partners, 4. Campaign Idea Prompts, Approaching Potential Partners (+25 more)

### Community 18 - "Vercel Optimize"
Cohesion: 0.09
Nodes (23): CandidateContractError, candidateLabel(), nonEmptyString(), VALID_SCOPES, validateCandidate(), validateCandidates(), applyHardGates(), flagsEndpointReason() (+15 more)

### Community 19 - "UI Components"
Cohesion: 0.06
Nodes (29): Hoist callbacks to the root of lists, Optimize List Performance with Stable Object References, Keep List Items Lightweight, Pass Primitives to List Items for Memoization, JavaScript, Navigation, 10.1 Use Compound Components Over Polymorphic Children, 10. Design System (+21 more)

### Community 20 - "Vercel Optimize"
Cohesion: 0.07
Nodes (17): MagneticButton(), MagneticButtonProps, conversionSteps, coverageItems, homeStats, marketContainerVariants, marketItemVariants, marketMedia (+9 more)

### Community 21 - "Community 21"
Cohesion: 0.10
Nodes (17): MarketPage(), MarketPageProps, Market, marketBySlug, MarketCapability, markets, MarketSlug, supportingImages (+9 more)

### Community 22 - "Conversion UI"
Cohesion: 0.09
Nodes (12): metadata, 1. Functional Directory Roles, Code Directory Context: Reusable UI Components, ConversionFooterCta(), proofItems, CustomCursor(), ClickPoint, LayoutProps (+4 more)
...
Cohesion: 0.07
Nodes (29): 10. IMAGE-FIRST CODEX WEBSITE WORKFLOW, 11. WHEN TO TRIGGER IMAGE GENERATION FIRST, 13. WEBSITE REFERENCE RULE, 15. RESPONSIVE FIRST-VIEW RULE, 16. ANTI-NESTED-BOX RULE, 17. REDUCE MICRO-UI CLUTTER RULE, 18. SECTION IMAGE GENERATION RULE, 19. WEBSITE IMAGE SYSTEM RULE (+21 more)
...
Cohesion: 0.12
Nodes (18): NotFound(), areaLandingPages, LandingPage, landingPageByKindAndSlug(), landingPageBySlug(), LandingPageKind, landingPagePath(), landingPages (+10 more)
...
### Community 30 - "React Best Practices"
Cohesion: 0.08
...
Cohesion: 0.17
Nodes (21): defaultNormalize(), normalizeColdStart(), normalizerFor(), QUERIES, checkAuth(), checkCliVersion(), exec, getProjectConfig() (+13 more)
...
Cohesion: 0.10
Nodes (21): 12. THE COMBINATORIAL VARIATION ENGINE, Background Character, Hero Architecture, Motion-Implied Language, Section System, Signature Component Set, Theme Paradigm, Typography Character (+13 more)
...
Cohesion: 0.22
Nodes (8): Avoid Boolean Prop Proliferation, Use Compound Components, Prefer Children Over Render Props, Create Explicit Component Variants, React 19 API Changes, Define Generic Context Interfaces for Dependency Injection, Decouple State Management from UI, Lift State into Provider Components

### Community 41 - "Deploy and CI"
Cohesion: 0.12
Nodes (18): Sections, 1. Eliminating Waterfalls (async), 2. Bundle Size Optimization (bundle), 3. Server-Side Performance (server), 4. Client-Side Data Fetching (client), 5. Re-render Optimization (rerender), 6. Rendering Performance (rendering), 7. JavaScript Performance (js) (+10 more)
...
Cohesion: 0.11
Nodes (18): 2 × 3 REFERENCE-STYLE LAYOUT, ANTI-GENERIC RULES, BOARD COMPOSITION DNA, BRAND STRATEGY FIRST, BRANDKIT IMAGE GENERATION SKILL, COLOR DISCIPLINE, CORE PRINCIPLE, DEFAULT OUTPUT (+10 more)
...
Cohesion: 0.11
Nodes (18): Agent-Specific Notes, Claude Code / terminal-based agents, CLI Auth Failure, Codex, Deploy to Vercel, Escalated Network Access (Codex / sandboxed environments), Linked (`.vercel/` exists) + has git remote → Git Push, Linked (`.vercel/` exists) + no git remote → `vercel deploy` (+10 more)
...
Cohesion: 0.13
Nodes (14): Animate transform/opacity, Load fonts natively at build time, Hoist Intl formatter creation, Use virtualized lists, Destructure functions early, Use Item Types for Heterogeneous Lists, Install Native Dependencies in App Directory, Wrap Strings in Text Components (+6 more)

### Community 52 - "Graphify and Skills"
Cohesion: 0.12
Nodes (16): 30. TYPOGRAPHY-FIRST DISCIPLINE, 31. SECTION RHYTHM RULE, 32. DENSITY & SPACING DISCIPLINE, 34. MULTI-IMAGE CONSISTENCY RULE, 36. RESPONSE BEHAVIOR, 14. IMAGE / MEDIA DIRECTION, 17. CLARITY CHECK, 1. ACTIVE BASELINE CONFIGURATION (+8 more)

### Community 53 - "UI Components"
Cohesion: 0.12
Nodes (17): devDependencies, autoprefixer, jsdom, pg, postcss, remotion, @remotion/cli, tailwindcss (+9 more)

### Community 54 - "Community 54"
Cohesion: 0.12
Nodes (17): path-to-regexp, overrides, ajv, esbuild, express, js-yaml, minimatch, path-to-regexp (+9 more)

### Community 55 - "Community 55"
Cohesion: 0.13
Nodes (16): Accessibility, addTransitionType, CSS Pseudo-Elements, CSS Recipes, Implementation Workflow, Next.js-Specific Patterns, Next.js Integration, Patterns (+8 more)
...
Cohesion: 0.16
Nodes (14): Color Palette, Design, Layout & Radius, Motion & Transitions, Typography, Visual Theme, Accessibility & Inclusion, Anti-references (+6 more)

### Community 60 - "Conversion UI"
Cohesion: 0.23
...
### Community 62 - "Site Pages"
Cohesion: 0.12
Nodes (16): dependencies, dotenv, express, leaflet, lucide-react, motion, next, @phosphor-icons/react (+8 more)
...
Cohesion: 0.12
Nodes (15): Backdrop-Blur Workaround, CSS Animation Recipes, Directional Navigation, Fade, Persistent Element Isolation, Reduced Motion, Scale, Separate Enter/Exit Classes (+7 more)
...
Cohesion: 0.15
Nodes (10): Statically Analyzable Paths, @mui/material, next/dynamic, Next.js, Avoid Barrel File Imports, Conditional Module Loading, Defer Non-Critical Third-Party Libraries, Dynamic Imports for Heavy Components (+2 more)

### Community 70 - "Community 70"
Cohesion: 0.13
Nodes (15): Above the Fold, Be Direct, Best Practices, Copywriting, Core Principles, Core Sections, CTA Copy Guidelines, Page Structure Framework (+7 more)
...
Cohesion: 0.14
Nodes (12): Caveats, Conclusion, Handoff Report, Logic Chain, Observation, Claim types, Dispositions, Re-gen trigger and accept criteria (+4 more)
...
### Community 76 - "React Best Practices"
Cohesion: 0.14
Nodes (13): 1. Skill Meta, 2.1 Swiss Industrial Print, 2.2 Tactical Telemetry & CRT Terminal, 2. Visual Archetypes, 3.1 Macro-Typography (Structural Headers), 3.2 Micro-Typography (Data & Telemetry), 3.3 Textural Contrast (Artistic Disruption), 3. Typographic Architecture (+5 more)

### Community 77 - "Community 77"
Cohesion: 0.14
Nodes (13): Agent Operating Manual, Asset Usage Notes, Claim Guardrail Checklist, Delivered Pages, Deployment Instructions, 🧬 Elite Branching & CI/CD Posture, Google Open Knowledge Notes, Image Usage Directory (+5 more)

### Community 78 - "Deploy and CI"
Cohesion: 0.27
Nodes (13): createGoal(), DASHBOARD_PATH, DB_PATH, executeNextTask(), generateHtmlDashboard(), getNextTask(), initDb(), loadDb() (+5 more)

### Community 79 - "Deploy and CI"
Cohesion: 0.14
Nodes (14): 4.1 Deduplicate Global Event Listeners, 4.2 Use Passive Event Listeners for Scrolling Performance, 4.3 Use SWR for Automatic Deduplication, 4.4 Version and Minimize localStorage Data, 4. Client-Side Data Fetching, 8.1 Do Not Put Effect Events in Dependency Arrays, 8.2 Initialize App Once, Not Per Mount, 8.3 Store Event Handlers in Refs (+6 more)

### Community 80 - "Graphify and Skills"
Cohesion: 0.15
Nodes (11): Application Shape, Architecture, Build Path, Key Directories, Operational Priorities, 🔴 Build & Prerender Errors, 🔴 Lead Form Submission & Webhook Failures, 🔴 Missing Assets or Media Errors (+3 more)

### Community 81 - "Site Pages"
Cohesion: 0.23
Nodes (10): byRoute(), gate(), metadata, round2(), sumRows(), extractErrors(), extractFromStatusRows(), gate() (+2 more)

### Community 82 - "Community 82"
Cohesion: 0.15
Nodes (13): 29. ANTI-AI-SLOP RULES, Content slop, Density slop, Layout slop, Typography slop, Visual slop, Carousel / marquee slop (layout), Content slop (+5 more)
...
Cohesion: 0.15
Nodes (11): Envelope-unwrap recovery, Grading rubric, Next.js version awareness, Provider rate limits, Schema, Table of contents, The 12 sanitizers, Avoid (+3 more)

### Community 86 - "SEO and Schema"
Cohesion: 0.15
Nodes (13): Animation, Core Rendering, List Performance, Scroll Performance, Rule Template, 2.1 Avoid Inline Objects in renderItem, 2.2 Hoist callbacks to the root of lists, 2.3 Keep List Items Lightweight (+5 more)

### Community 87 - "Site Pages"
Cohesion: 0.15
Nodes (13): 2.1 Decouple State Management from UI, 2.2 Define Generic Context Interfaces for Dependency Injection, 2.3 Lift State into Provider Components, 2. State Management, 3.1 Create Explicit Component Variants, 3.2 Prefer Composing Children Over Render Props, 3. Implementation Patterns, 4.1 React 19 API Changes (+5 more)

### Community 88 - "UI Components"
Cohesion: 0.17
Nodes (11): Acceptance Criteria, Build & Code Hygiene, Conversion & Core Pages, Follow-up — 2026-06-12T20:20:23Z, Follow-up — 2026-06-12T20:20:59Z, Initial Request — 2026-06-12T20:19:30Z, Original User Request, R1. Stunning Visual Redesign & Conversion Audit (+3 more)

### Community 89 - "Vercel Optimize"
Cohesion: 0.32
Nodes (12): Compliance Agent, Agentic OS Control Plane Dashboard, Architectural Decisions & Guardrails, Design Agent, GOAL-1-T1: Compliance and Terminology Audit, GOAL-1-T2: Visual Redesign & Contrast Alignment, GOAL-1-T3: Interactive Micro-animations & Transitions, GOAL-1-T4: Verification Suite Execution (+4 more)
...
Cohesion: 0.23
Nodes (11): 1. Residential Painting Landing Page 🧬, 2. Commercial & Facility Painting Landing Page 🧬, 3. Parking Lot Striping & Pavement Markings Landing Page 🧬, 4. Public-Sector & Municipal Painting Landing Page 🧬, Bid Prerequisites, Core Benefits & Value Propositions, Core Capabilities, Credentials Banner (+3 more)
...
Cohesion: 0.18
Nodes (11): 1. Logo Cover, 2. Logo Construction, 3. Digital Application, 4. Brand Essence, 5. Color System, 7. Physical Application, 8. Image Direction, 9. System Detail (+3 more)

### Community 94 - "Vercel Optimize"
Cohesion: 0.18
Nodes (11): Conversion Rate Optimization (CRO), Copy Alternatives, Experiment Ideas, Form Optimization, High-Impact Changes (Prioritize), Initial Assessment, Output Format, Quick Wins (Implement Now) (+3 more)

### Community 95 - "Vercel Optimize"
Cohesion: 0.18
Nodes (10): 📦 1. Dependency & Compiler Audit, 🔒 2. API Route & Security Hardening, 🌐 3. Vercel Configuration & Routing, 📈 4. SEO & NAP Schema Integrity, 📱 5. Mobile & UX Audit, 🚀 6. Handoff & Production Readiness checklist, `/api/leads` and `/api/manychat` Upgrades:, Audit Status: PASS ✅ (+2 more)
...
Cohesion: 0.22
Nodes (10): AI Application Playbook, API Service Playbook, Content Site Playbook, E-commerce Playbook, Marketing Site Playbook, SaaS Playbook, SvelteKit Playbook, Scanner Patterns (+2 more)

### Community 100 - "Site Pages"
Cohesion: 0.18
Nodes (10): Use contentInsetAdjustmentBehavior for Safe Areas, 9.1 Measuring View Dimensions, 9.2 Modern React Native Styling Patterns, 9.3 Use contentInset for Dynamic ScrollView Spacing, 9.5 Use expo-image for Optimized Images, 9.6 Use Galeria for Image Galleries and Lightbox, 9.7 Use Native Menus for Dropdowns and Context Menus, 9.8 Use Native Modals Over JS-Based Bottom Sheets (+2 more)
...
Cohesion: 0.20
Nodes (10): AGENTS.md // Website operating manual, Branches and pull requests, Deployment and infrastructure, Design and content safeguards, External research, Google Open Knowledge standard, Graph and wiki freshness, Operating order (+2 more)

### Community 104 - "UI Components"
Cohesion: 0.22
Nodes (8): AGENTS.md Compiled Output, docs/google-open-knowledge.md, Sections Metadata, Add A Topic, Rules, Support Topics, Rule Template, Vercel React Best Practices Skill

### Community 105 - "Community 105"
Cohesion: 0.22
Nodes (6): better-all, better-all, Prevent Waterfall Chains in API Routes, Dependency-Based Parallelization, Promise.all() for Independent Operations, Strategic Suspense Boundaries

### Community 106 - "Community 106"
Cohesion: 0.20
Nodes (9): 5. PERFORMANCE GUARDRAILS, 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 8. PRE-OUTPUT CHECKLIST, A. Vibe & Texture Archetypes (Pick 1), Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier), B. Layout Archetypes (Pick 1) (+1 more)

### Community 107 - "Community 107"
Cohesion: 0.20
Nodes (10): 14. HERO MINIMALISM RULES, Absolute Hero Rules, Headline Rule, Hero Cleanliness Rule, Absolute Hero Rules, Graphic Restraint, Headline Rule, Hero Composition Bias (+2 more)
...
Cohesion: 0.20
Nodes (10): Absolute bans, Color, Color & Theme, Design guidance, General rules, Interaction, Layout, Motion (+2 more)
...
Cohesion: 0.20
Nodes (8): engines, node, name, private, type, version, headers, redirects
...
Cohesion: 0.20
Nodes (9): Fix Priority, How This Works, Layout Upgrades, Motion Upgrades, Redesign Skill, Rules, Surface Upgrades, Typography Upgrades (+1 more)
...
### Community 122 - "React Best Practices"
Cohesion: 0.22
Nodes (8): Artifact Index, BRIEFING — 2026-06-12T20:19:30Z, 🔒 Key Constraints, Mission, 🔒 My Identity, Project Status, User Context, Victory Audit Status
...
Cohesion: 0.22
Nodes (8): AGENTS.md, Commands, graphify, Guidelines, CLAUDE.md Developer & Agent Reference Guide, PROJECT.md: Visual Redesign & Functionality Audit, test_out.txt: E2E test failures (App.tsx routing), test_out_utf8.txt: E2E test failures (UTF-8 variant)
...
### Community 131 - "Graphify and Skills"
Cohesion: 0.22
...
Cohesion: 0.39
Nodes (7): sanitizeCitations(), applyDollarStrip(), stripDollarLiterals(), applySanitizers(), applySanitizersBatch(), recordSanitizer(), SANITIZERS

### Community 133 - "Conversion UI"
Cohesion: 0.22
Nodes (8): 1. Protocol Overview, 2. Absolute Negative Constraints (Banned Elements), 3. Typographic Architecture, 4. Color Palette (Warm Monochrome + Spot Pastels), 5. Component Specifications, 6. Iconography & Imagery Directives, 7. Subtle Motion & Micro-Animations, Protocol: Premium Utilitarian Minimalism UI Architect

### Community 134 - "React Best Practices"
Cohesion: 0.22
Nodes (9): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Iconography, Interactivity and States, Layout (+1 more)
...
Cohesion: 0.22
Nodes (8): Do Not Recommend When, Evidence To Check, Investigation Brief, Do Not Recommend When, Evidence To Check, Investigation Brief, Verification, Verification
...
Cohesion: 0.43
Nodes (5): A/B Testing Skill, AI SEO Skill, Churn Prevention Skill, SEO Audit Skill, Site Architecture Skill

### Community 140 - "Community 140"
Cohesion: 0.25
Nodes (8): 1. Value Proposition Clarity (Highest Impact), 2. Headline Effectiveness, 3. CTA Placement, Copy, and Hierarchy, 4. Visual Hierarchy and Scannability, 5. Trust Signals and Social Proof, 6. Objection Handling, 7. Friction Points, CRO Analysis Framework

### Community 141 - "Community 141"
Cohesion: 0.25
Nodes (7): Deployment Protocol, 🔄 Emergency Rollback Protocol, 🔗 Route Additions & Registration Rules, 📦 Running Manual Vercel Deployments (If needed), 🔑 Secrets & Environment Variables, 🛠️ Strict Pre-Deployment Gates (Pre-Flight), 🚀 Target Production Environment

### Community 142 - "Backend and Leads"
Cohesion: 0.25
Nodes (7): Claim guardrails, Entity model, Goal, Google Open Knowledge operating guide, Page requirements, Source of truth, Validation

### Community 143 - "Community 143"
Cohesion: 0.25
Nodes (7): HubSpot and Google Sheets Integration Guide, 1. HubSpot Welcome List Configuration 🧬, 2. Automated Responder Email Template 🧬, 3. Google Sheets Integration Map 🧬, A. Dynamic List: "New Twin Cities Prospects", Column Mapping:, Subject Line: Your Twin Cities Painting Project — Sky's the Limit Painting LLC

### Community 144 - "Community 144"
Cohesion: 0.25
Nodes (7): Architecture, Code Layout, Interface Contracts, Milestones, Project: Sky's the Limit Painting LLC Visual Redesign & Functionality Audit, `src/components/LeadForm.tsx` ↔ `api/leads.ts`, `src/pages/Review.tsx` ↔ Google Reviews vs Private Feedback Form
...
Cohesion: 0.29
Nodes (6): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), High-Agency Frontend Skill

### Community 152 - "Graphify and Skills"
Cohesion: 0.29
Nodes (6): Banned Output Patterns, Baseline, Execution Process, Full-Output Enforcement, Handling Long Outputs, Quick Check

### Community 153 - "Backend and Leads"
Cohesion: 0.29
Nodes (7): 37. EXAMPLE INTERPRETATIONS, Example 1, Example 2, Example 3, Example 1, Example 2, Example 3
...
Cohesion: 0.29
Nodes (7): Anthony Briseno, Commercial Painting Division, Public-Sector Readiness Division, Residential Painting Division, Sky's the Limit Painting LLC, Sitemap Generator Script, Test Suite Results

### Community 159 - "React Best Practices"
Cohesion: 0.29
Nodes (5): Map, RegExp, Hoist RegExp Creation, Build Index Maps for Repeated Lookups, useMemo

### Community 160 - "React Best Practices"
Cohesion: 0.29
Nodes (6): Commercial & Public-Sector Pricing, Components & Variables, Cost & Pricing Guide — Sky's the Limit Painting LLC, Formula, Residential Painting Estimations, Room Presets (Examples)
...
Cohesion: 0.29
Nodes (7): Before/after code fences required, Cite at least one URL from the library, Cite codebase findings with line numbers, Lead with impact, Match the user's framework version, No $ literals in customer fields, Writing rules

### Community 163 - "Community 163"
Cohesion: 0.29
Nodes (7): Agentic OS Principal Architect Doctrine, Content & Emoji Policy, Sky's the Limit Custom Policies & Constraints, Legal & Contractor Compliance, Agentic OS Control Rules & Project Guardrails, Shell Execution & Verification Protocols, Visual & Design Rules
...
Cohesion: 0.40
Nodes (4): Array sort, Math.min/Math.max, Early Length Check for Array Comparisons, Use Loop for Min/Max Instead of Sort

### Community 173 - "Community 173"
Cohesion: 0.33
Nodes (6): 1. Monogram + Meaning, 2. Product Action, 3. Metaphor Fusion, 4. Negative Space, 5. Construction Geometry, LOGO CONCEPT METHODS

### Community 176 - "Community 176"
Cohesion: 0.33
Nodes (5): Documentation Routing, Exact Edit Targets, Primary Routes, Verification Hooks, Website Context Map

### Community 177 - "Deploy and CI"
Cohesion: 0.33
Nodes (6): About Page, Feature Page, Homepage, Landing Page, Page-Specific Guidance, Pricing Page

### Community 178 - "UI Components"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (6): Blog Post CRO, Feature Page CRO, Homepage CRO, Landing Page CRO, Page-Specific Frameworks, Pricing Page CRO

### Community 180 - "Vercel Optimize"
Cohesion: 0.33
Nodes (5): 🧬 Code Standards & Agent Discipline, 🔀 Git & Branching Standards, Repository Rules, 🔒 Security Rules, 🛠️ Verification Gates Before Merge
...
Cohesion: 0.33
Nodes (3): Minimize State Variables and Derive Values, Calculate Derived State During Rendering, Subscribe to Derived State
...
Cohesion: 0.47
Nodes (5): [0.1.3](https://github.com/supabase/agent-skills/compare/v0.1.2...v0.1.3) (2026-06-02), [0.1.4](https://github.com/supabase/agent-skills/compare/v0.1.3...v0.1.4) (2026-06-05), Bug Fixes, Changelog, Features

### Community 203 - "Build Scripts"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (5): 7. AI TELLS (Forbidden Patterns), Content & Data (The "Jane Doe" Effect), External Resources & Components, Layout & Spacing, Visual & CSS

### Community 211 - "Community 211"
Cohesion: 0.40
Nodes (4): 🔀 Branching Guidelines, 🚥 PR Quality & Merging Gates, 📋 Pull Request Submission & Template, Repository Organization

### Community 212 - "Vercel Optimize"
Cohesion: 0.60
...
### Community 214 - "React Best Practices"
Cohesion: 0.60
...
### Community 217 - "React Best Practices"
Cohesion: 0.60
...
### Community 226 - "Vercel Optimize"
Cohesion: 0.40
Nodes (3): Use .get() and .set() for Reanimated Shared Values (not .value), Use GestureDetector for Animated Press States, Use Pressable Instead of Touchable Components

### Community 227 - "Deploy and CI"
Cohesion: 0.50
Nodes (3): React useEffectEvent docs, Do Not Put Effect Events in Dependency Arrays, Store Event Handlers in Refs
...
Cohesion: 0.80
Nodes (4): get_file_size_kb(), main(), minify_svg(), optimize_image()

### Community 231 - "UI Components"
Cohesion: 0.40
Nodes (4): writing-guidelines, Guidelines Source, How It Works, Usage

### Community 232 - "Vercel Optimize"
Cohesion: 0.60
Nodes (3): config, proxy(), updateSession()

### Community 233 - "Community 233"
Cohesion: 0.40
Nodes (4): [1.3.0](https://github.com/supabase/agent-skills/compare/v1.2.0...v1.3.0) (2026-06-05), Bug Fixes, Changelog, Features

### Community 234 - "Community 234"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification

### Community 235 - "UI Components"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification
...
### Community 238 - "Vercel Optimize"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification

### Community 239 - "UI Components"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification
...
### Community 246 - "Build Scripts"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification

### Community 247 - "Deploy and CI"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification
...
### Community 253 - "UI Components"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification

### Community 254 - "UI Components"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification
...
### Community 272 - "React Best Practices"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification

### Community 273 - "Deploy and CI"
Cohesion: 0.40
Nodes (4): Do Not Recommend When, Evidence To Check, Investigation Brief, Verification
...
### Community 280 - "React Best Practices"
Cohesion: 0.50
Nodes (4): 9. THE "MOTION-ENGINE" BENTO PARADIGM, A. Core Design Philosophy, B. The Animation Engine Specs (Perpetual Motion), C. The 5-Card Archetypes (Micro-Animation Specs)
...
### Community 282 - "React Best Practices"
Cohesion: 0.67
...
### Community 285 - "SEO and Schema"
Cohesion: 0.50
Nodes (4): 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), A. The "Double-Bezel" (Doppelrand / Nested Architecture), B. Nested CTA & "Island" Button Architecture, C. Spatial Rhythm & Tension

### Community 286 - "Graphify and Skills"
Cohesion: 0.50
...
### Community 287 - "Graphify and Skills"
Cohesion: 0.50
Nodes (4): 33. DEFAULT SECTION PACKS, 4-section pack, 15. DEFAULT SITE PACKS, 4-section pack

### Community 288 - "UI Components"
Cohesion: 0.50
Nodes (4): 2. PLATFORM MODE RULE, Android-native premium, Cross-platform premium neutral, iOS-native premium

### Community 289 - "UI Components"
Cohesion: 0.50
Nodes (4): 37. EXAMPLE INTERPRETATIONS, Example 1, Example 2, Example 3

### Community 290 - "Graphify and Skills"
Cohesion: 0.67
Nodes (3): ai, analyze(), main()

### Community 291 - "Vercel Optimize"
Cohesion: 0.50
...
### Community 315 - "Deploy and CI"
Cohesion: 1.00
Nodes (3): .agents/BRIEFING.md: Sentinel Mission Briefing, .agents/handoff.md: Sentinel Handoff Report, .agents/ORIGINAL_REQUEST.md: Original User Request
...
- `Cold-start initialization and bundle weight` → `Core Web Vitals client bottlenecks`  [AMBIGUOUS]
  .agents/skills/vercel-optimize/references/support-topics/core-web-vitals-client-bottlenecks.md · relation: conceptually_related_to
- `Usage spike triage` → `Remote cache for shared origin data`  [AMBIGUOUS]
  .agents/skills/vercel-optimize/references/support-topics/use-cache-remote-shared-origin-data.md · relation: shares_data_with

## Knowledge Gaps
- **2096 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `HERE`, `LIBRARY_PATH`, `SERVICE_DIMENSION` (+2091 more)
...
- **What is the exact relationship between `Cold-start initialization and bundle weight` and `Core Web Vitals client bottlenecks`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Usage spike triage` and `Remote cache for shared origin data`?**
  _Edge tagged AMBIGUOUS (relation: shares_data_with) - confidence is low._
- **Why does `Vercel Optimize Skill` connect `Community 99` to `Community 161`, `React Best Practices`, `UI Components`, `Community 74`, `Vercel Optimize`, `Build Scripts`, `Remotion Brand Films`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `AGENTS.md Compiled Output` connect `UI Components` to `Build Scripts`, `Community 124`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `gates` connect `React Best Practices` to `Vercel Optimize`, `UI Components`, `Site Pages`, `React Best Practices`?**
...
- **Should `Backend and Leads` be split into smaller, more focused modules?**
