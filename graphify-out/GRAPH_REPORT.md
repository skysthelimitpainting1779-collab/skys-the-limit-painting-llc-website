# Graph Report - C:\Users\Johnny Cage\DEV\skysthelimit-collab  (2026-06-20)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 1964 nodes · 3021 edges · 341 communities (140 shown, 201 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 144 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c7ebb20`
...
4. `canonicalizeRoute()` - 25 edges
5. `recText()` - 24 edges
6. `renderReport()` - 24 edges
7. `main()` - 24 edges
8. `recText()` - 23 edges
...
- `tests/e2e.test.mjs` --conceptually_related_to--> `Compliance Requirement: No forbidden claims`  [INFERRED]
  tests/e2e.test.mjs → .agents/sub_orch_impl/m2_worker/ORIGINAL_REQUEST.md
- `BRIEFING — Mission Audit Compliance Claims` --references--> `remediation.test.mjs - Remediation Test`  [EXTRACTED]
  .agents/sub_orch_impl/m2_explorer_2/BRIEFING.md → tests/remediation.test.mjs
- `BRIEFING — Mission Audit Compliance Claims` --references--> `site-architecture.test.mjs - Site Architecture Test`  [EXTRACTED]
  .agents/sub_orch_impl/m2_explorer_2/BRIEFING.md → tests/site-architecture.test.mjs
- `tests/e2e.test.mjs` --references--> `MN Statute 176.041`  [EXTRACTED]
  tests/e2e.test.mjs → .agents/sub_orch_impl/m2_worker/ORIGINAL_REQUEST.md
- `tests/e2e.test.mjs` --references--> `Registration ID: IR816596`  [EXTRACTED]
  tests/e2e.test.mjs → .agents/sub_orch_impl/m2_worker/ORIGINAL_REQUEST.md

## Import Cycles
- None detected.

## Communities (341 total, 201 thin omitted)
...
Cohesion: 0.06
Nodes (36): sanitizeCitations(), computeImpactLabel(), cwvIssue(), formatCwvIssue(), formatInteger(), joinEnglish(), parseSigNumber(), round1() (+28 more)
...
Cohesion: 0.09
Nodes (15): BeforeAfterSliderProps, MarketPage(), MarketPageProps, ResponsiveImage(), ResponsiveImageProps, Market, marketBySlug, breadcrumbSchema() (+7 more)
...
Cohesion: 0.08
Nodes (15): BookingCtaProps, bookingLabels, budgetOptions, contactMethods, LeadFormProps, projectOptions, propertyOptions, Status (+7 more)
...
Cohesion: 0.16
Nodes (24): summarizeClaimResults(), applyQualityFloor(), grade(), gradeRecommendation(), isAccountScope(), roundTo(), scoreActionability(), scoreEvidence() (+16 more)
...
Cohesion: 0.09
Nodes (14): MagneticButton(), MagneticButtonProps, metadata, Code Directory Context: Reusable UI Components, ConversionFooterCta(), proofItems, CustomCursor(), ClickPoint (+6 more)

### Community 15 - "Vercel Optimize"
Cohesion: 0.11
Nodes (14): LayoutProps, areaLandingPages, LandingPage, landingPageByKindAndSlug(), landingPageBySlug(), LandingPageKind, landingPagePath(), landingPages (+6 more)
...
Cohesion: 0.13
Nodes (11): Testimonial, testimonials, proofItems, ServiceAreaMapProps, serviceAreaPins, AnalyticsPayload, readUtmParams(), trackEvent() (+3 more)

### Community 30 - "React Best Practices"
Cohesion: 0.11
Nodes (19): dependencies, dotenv, express, leaflet, lucide-react, motion, next, @phosphor-icons/react (+11 more)
...
Cohesion: 0.25
Nodes (5): gates, extractRows(), gate(), metadata, metadata
...
Cohesion: 0.43
Nodes (8): A/B Testing Skill, AI SEO Skill, Analytics Tracking Skill, Churn Prevention Skill, Copywriting Skill, Conversion Rate Optimization Skill, SEO Audit Skill, Site Architecture Skill
...
## Knowledge Gaps
- **643 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `HERE`, `LIBRARY_PATH`, `SERVICE_DIMENSION` (+638 more)
...
- **Why does `gates` connect `Conversion UI` to `Vercel Optimize`, `Deploy and CI`, `UI Components`, `Vercel Optimize`, `UI Components`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `scanners` connect `React Best Practices` to `Vercel Optimize`, `Vercel Optimize`, `UI Components`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `SEO and Schema` to `Vercel Optimize`, `UI Components`, `Deploy and CI`, `Vercel Optimize`, `Graphify and Skills`, `Vercel Optimize`, `Community 54`, `Vercel Optimize`, `React Best Practices`?**
