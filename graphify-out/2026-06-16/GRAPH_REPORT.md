# Graph Report - C:\Users\Johnny Cage\DEV\skysthelimit-collab  (2026-06-16)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 1929 nodes · 2988 edges · 342 communities (139 shown, 203 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 144 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1897299`
...
## Communities (342 total, 203 thin omitted)
...
Cohesion: 0.11
Nodes (22): extractRoute(), lineOf(), apply(), metadata, apply(), metadata, MODE_PATTERNS, isApplicable() (+14 more)
...
Cohesion: 0.11
Nodes (15): extractColdStarts(), gate(), metadata, gates, extractRows(), gate(), metadata, gate() (+7 more)
...
Cohesion: 0.12
Nodes (8): BeforeAfterSliderProps, Code Directory Context: Reusable UI Components, ResponsiveImage(), ResponsiveImageProps, proofItems, ServiceAreaMapProps, serviceAreaPins, Code Directory Context: Source Root
...
Cohesion: 0.12
Nodes (17): dependencies, dotenv, express, leaflet, lucide-react, motion, next, @phosphor-icons/react (+9 more)
...
Cohesion: 0.18
Nodes (10): engines, node, name, overrides, js-yaml, source-map, tar, private (+2 more)
...
## Knowledge Gaps
- **625 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `HERE`, `LIBRARY_PATH`, `SERVICE_DIMENSION` (+620 more)
...
- **Why does `gates` connect `Vercel Optimize` to `Community 32`, `Site Pages`, `SEO and Schema`, `UI Components`, `SEO and Schema`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `scanners` connect `SEO and Schema` to `Vercel Optimize`, `Site Pages`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `canonicalizeRoute()` connect `Conversion UI` to `Backend and Leads`, `Vercel Optimize`, `React Best Practices`, `SEO and Schema`, `Conversion UI`, `Conversion UI`?**
