...
last_sync: 2026-06-24T19:49:37.832Z
---
...
- **Per-Request Deduplication with React.cache()** (0 connections) — `.agents/skills/vercel-react-best-practices/rules/server-cache-react.md`
