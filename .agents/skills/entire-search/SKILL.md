---
name: entire-search
description: Search Entire checkpoint/session history with entire search --json. Use for prior agent work, commits, prompts, transcripts.
---
...
Always `entire search --json`. Requires `entire login` for hosted search.
