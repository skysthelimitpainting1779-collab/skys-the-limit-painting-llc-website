...
*   **BeforeAfterSlider.tsx** — Interactive comparison slider showing meticulous prep vs flawless finished coat.
*   **BookingCta.tsx** — Prominent call-to-action button prompting leads to schedule estimates.
*   **ConversionHeader.tsx** — Premium navigation header featuring phone links, service menus, and primary CTAs.
...
*   **Layout.tsx** — Master frame containing the responsive header, footer, custom cursor, and transition layouts.
