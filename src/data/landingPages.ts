...
export const areaLandingPages: LandingPage[] = [
  {
    ...
    headline:
      'Owner-operated painting based in Inver Grove Heights, built for homes, properties, and facility work.',
    description:
  ...
  },
  {
    ...
    headline:
      'Careful painting for South St. Paul homes, shops, rentals, and small facilities.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Nearby Inver Grove Heights base',
      'Clean prep and protection',
      'Commercial and residential scope paths',
    ],
    scope: [
      'Interior walls and ceilings',
      'Trim, doors, and detail painting',
      'Small commercial refreshes',
      'Rental turnover painting',
      'Exterior painting conversations',
    ],
    process: [
      {
        title: 'Walk The Project',
        body: 'Confirm the room, building, surface, access, timing, and prep needs.',
      },
      {
        title: 'Protect The Space',
        body: 'Cover floors, fixtures, and adjacent surfaces before coating work starts.',
      },
      {
        title: 'Close Cleanly',
        body: 'Review touchups, cleanup, and next-step documentation before the job wraps.',
      },
    ],
    related: [
      'inver-grove-heights',
  ...
  },
  {
    ...
    headline:
      'Structured painting support for St. Paul homes, storefronts, offices, and property refreshes.',
    description:
    ...
    market: 'Commercial',
    proof: [
      'Commercial presentation mindset',
      'Residential detail standards',
      'Remote photo estimate reviews',
    ],
    scope: [
      'Storefront repainting',
      'Office interiors',
      'Residential rooms and trim',
      'Occupied-space planning',
      'Facility painting conversations',
    ],
    process: [
      {
        title: 'Clarify Access',
        body: 'Identify occupied-space concerns, parking, tenant timing, and surfaces before scheduling.',
      },
      {
        title: 'Stage With Control',
        body: 'Plan protection, masking, materials, and cleanup around the way the property is used.',
      },
      {
        title: 'Document The Result',
        body: 'Capture closeout notes and photos so the finished work has a usable record.',
      },
    ],
    related: [
      'commercial-painting',
  ...
  },
  {
    ...
    headline:
      'Prep-first painting for Eagan homeowners, property managers, and commercial spaces.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Clean residential protection',
      'Commercial scheduling awareness',
      'Owner-operated communication',
    ],
    scope: [
      'Bedroom and living-area repainting',
      'Trim and door painting',
      'Commercial interiors',
      'Exterior refresh planning',
      'Paint-ready drywall repair',
    ],
    process: [
      {
        title: 'Define The Finish',
        body: 'Match scope, sheen, prep, timing, and expectations before the estimate is finalized.',
      },
      {
        title: 'Prep Before Paint',
        body: 'Patch, sand, mask, caulk, cover, and prime where the surface requires it.',
      },
      {
        title: 'Walk The Work',
        body: 'Review the project together and handle closeout details before calling it done.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Clean residential and commercial painting for Woodbury projects that need a sharper finish.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Residential detail mindset',
      'Property-refresh capability',
      'Clear estimate intake',
    ],
    scope: [
      'Interior repainting',
      'Trim and doors',
      'Commercial touchups and refreshes',
      'Exterior surface review',
      'Deck and fence staining inquiries',
    ],
    process: [
      {
        title: 'Review The Space',
        body: 'Document rooms, surfaces, damage, colors, access, and timing.',
      },
      {
        title: 'Plan Protection',
        body: 'Prepare a clean work path that respects floors, fixtures, furniture, and active spaces.',
      },
      {
        title: 'Finish With Accountability',
        body: 'Tie the final walkthrough to visible touchups, cleanup, and owner-led follow-through.',
      },
    ],
    related: [
      'eagan',
  ...
  },
  {
    ...
    headline:
      'A serious painting partner for Minneapolis homes, commercial interiors, and facility refreshes.',
    description:
    ...
    proof: [
      ...
      'Residential finish discipline',
      'Documentation-minded estimates',
    ],
    scope: [
      'Commercial interiors',
      'Office and retail repainting',
      'Residential rooms and trim',
      'Facility refreshes',
      'Remote visual scoping',
    ],
    process: [
      {
        title: 'Tailor The Scope',
        body: 'Customize each proposal to match the exact needs of homeowners, property managers, or facility departments.',
      },
      {
        title: 'Confirm Constraints',
        body: 'Plan for access, schedules, cleanup, surface prep, and work around occupied spaces.',
      },
      {
        title: 'Deliver A Record',
        body: 'Use notes and photos to keep the job accountable after the first conversation.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Residential detail, commercial discipline, and public-sector readiness across the Twin Cities.',
    description:
    ...
    proof: [
      'Complete three-sector capability',
      'Streamlined digital estimations',
      'Owner-operated follow-through',
    ],
    scope: [
      'Residential painting',
      'Commercial painting',
      'Public-sector readiness',
      'Pavement marking conversations',
      'Facility repainting',
    ],
    process: [
      {
        title: 'Assess Coating Needs',
        body: 'Analyze project specifications for residential, commercial, or public facility upgrades to determine the optimal products and prep.',
      },
      {
        title: 'Verify Details',
        body: 'Evaluate surface conditions, square footage, specific timelines, and your preferred access methods.',
      },
      {
        title: 'Deliver Proposals',
        body: 'Provide highly itemized estimates specifying exact preparation methods, paint specs, and linear measurements.',
      },
    ],
    related: [
      'residential',
...
export const serviceLandingPages: LandingPage[] = [
  {
    ...
    headline:
      'Interior painting with careful prep, cleaner lines, and respect for the space.',
    description:
    ...
    scope: [
      ...
      'Ceiling repainting',
      'Trim and doors',
      'Patch and prime areas',
      'Occupied home protection',
    ],
    process: [
      {
        title: 'Protect',
        body: 'Cover floors, furniture, fixtures, and paths before tools and paint move through the space.',
      },
      {
        title: 'Prepare',
        body: 'Patch, sand, caulk, mask, spot-prime, and solve visible surface issues.',
      },
      {
        title: 'Finish',
        body: 'Apply clean coats, review lines and coverage, then handle touchups and cleanup.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Exterior painting conversations built around prep, timing, weather, and lasting presentation.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Prep-first exterior review',
      'Weather-aware scheduling',
      'Curb-appeal presentation',
    ],
    scope: [
      'Siding and trim review',
      'Doors and detail areas',
      'Peeling or worn surfaces',
      'Caulking and patch planning',
      'Exterior color refreshes',
    ],
    process: [
      {
        title: 'Inspect',
        body: 'Review surface condition, access, peeling, moisture concerns, prep needs, and timing.',
      },
      {
        title: 'Prepare',
        body: 'Plan cleaning, scraping, sanding, caulking, masking, and priming where needed.',
      },
      {
        title: 'Coat',
        body: 'Apply the right approach for the surface and close with a visible review.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Commercial painting for spaces where presentation, schedule, and cleanup matter.',
    description:
    ...
    market: 'Commercial',
    proof: [
      'Retail and office presentation',
      'Occupied-space awareness',
    ...
    scope: [
      ...
      'Back-of-house rooms',
      'Facility refreshes',
      'Touchup and repaint planning',
    ],
    process: [
      {
        title: 'Plan Access',
        body: 'Clarify business hours, occupied areas, fixtures, traffic paths, and staging constraints.',
      },
      {
        title: 'Protect Operations',
        body: 'Mask and cover adjacent surfaces while keeping the work area orderly.',
      },
      {
        title: 'Close Professionally',
        body: 'Review the result, handle touchups, and leave a cleaner property presentation.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Cabinet painting inquiries scoped around prep, adhesion, finish expectations, and durability.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Adhesion and prep conversation',
      'Masking and protection planning',
      'Finish expectation review',
    ],
    scope: [
      'Kitchen cabinet repaint inquiries',
      'Vanity painting conversations',
      'Door and drawer prep',
      'Primer and coating discussion',
      'Visual surface review',
    ],
    process: [
      {
        title: 'Review Photos',
        body: 'Start with cabinet photos, material notes, condition, hardware, and desired finish.',
      },
      {
        title: 'Define Prep',
        body: 'Discuss cleaning, sanding, adhesion primer, masking, and drying or cure expectations.',
      },
      {
        title: 'Scope Honestly',
        body: 'Confirm whether the project is a fit before promising a cabinet finish.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Paint-ready drywall repair for projects where the finish depends on the prep.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Patch and prime methods',
      'Surface prep tied to paint quality',
      'Visual scoping available',
    ],
    scope: [
      'Small wall repairs',
      'Dents and holes',
    ...
    process: [
      {
        title: 'Identify Damage',
        body: 'Collect photos, location, size, surface type, and whether texture matching is required.',
      },
      {
        title: 'Prep The Surface',
        body: 'Patch, sand, prime, and prepare the area for a cleaner paint finish.',
      },
      {
        title: 'Finish The Room',
        body: 'Tie repair work into the repaint scope so the wall does not look patched and forgotten.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Deck and fence staining conversations built around condition, cleaning, prep, and weather.',
    description:
    ...
    market: 'Residential',
    proof: [
      'Condition review first',
      'Weather-aware scheduling',
      'Prep and coating conversation',
    ],
    scope: [
      'Fence staining inquiries',
      'Deck staining conversations',
      'Cleaning and prep review',
      'Weathered wood evaluation',
      'Exterior finish planning',
    ],
    process: [
      {
        title: 'Check Condition',
        body: 'Review age, previous coating, weathering, access, and photos before estimating.',
      },
      {
        title: 'Plan Prep',
        body: 'Discuss cleaning, drying, sanding, masking, and product fit.',
      },
      {
        title: 'Time The Work',
        body: 'Schedule around Minnesota weather and realistic dry-time expectations.',
      },
    ],
  ...
  },
  {
    ...
    headline:
      'Parking lot striping for clearer traffic flow, cleaner presentation, and stronger property arrival.',
    description:
    ...
    market: 'Public Sector',
    proof: [
      'Layout and visibility focus',
      'Commercial property presentation',
      'Public-facing surface readiness',
    ],
    scope: [
      'Parking stall lines',
      ...
      'Small-lot refreshes',
      'Facility lots',
      'Property arrival improvements',
    ],
    process: [
      {
        title: 'Assess The Lot',
        body: 'Review existing markings, pavement condition, traffic flow, and layout needs.',
      },
      {
        title: 'Prepare The Surface',
        body: 'Plan cleaning, debris removal, chalk lines, and access timing.',
      },
      {
        title: 'Stripe For Clarity',
        body: 'Focus on visibility, flow, property presentation, and closeout photos.',
      },
    ],
    related: [
      'public-sector',
  ...
  },
  {
    ...
    headline:
      'Pavement marking inquiries for properties and qualified opportunities that need clear surface communication.',
    description:
    ...
    market: 'Public Sector',
    proof: [
      'Documentation-minded scope',
      'Commercial and facility fit',
      'Public-sector readiness language',
    ],
    scope: [
      'Safety markings',
      'Parking lot markings',
      'Traffic-flow markings',
      'Facility surface markings',
      'Qualified opportunity review',
    ],
    process: [
      {
        title: 'Document Need',
        body: 'Collect location, photos, current markings, dimensions, access, and timing requirements.',
      },
      {
        title: 'Plan Execution',
        body: 'Clarify layout, surface condition, cleaning needs, materials, and work windows.',
      },
      {
        title: 'Close With Proof',
        body: 'Use photos and notes to record the completed surface work.',
      },
    ],
    related: [
      'public-sector',
...
export function landingPagePath(page: LandingPage) {
  return page.kind === 'area'
    ? `/service-areas/${page.slug}`
