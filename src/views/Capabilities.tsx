          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-300 max-w-xl">
                Professional commercial, facility, and public-sector specialty
                painting services from a registered Minnesota Specialty
                Contractor (Painting).
              </p>
              <div className="mt-8">
                <a
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="border border-white/10 bg-[#0B0B0D] p-6 hover:-translate-y-1 hover:border-white/45 transition duration-500">
                    ...
                    <p className="text-sm text-[#b9b2a6]">
                      High-durability coatings, protective sealants, drywall
                      repairs, and precise cutting-in for retail spaces,
                      corporate offices, and property developments.
                    </p>
                  </div>
                  <div className="border border-white/10 bg-[#0B0B0D] p-6 hover:-translate-y-1 hover:border-white/45 transition duration-500">
                    <h3 className="font-bold text-white text-sm mb-3">
                      Specialty Pavement Striping
                    </h3>
                    <p className="text-sm text-[#b9b2a6]">
                      Standard parking lot layout markings, ADA-compliant
                      stencils, curb paint, and municipal parking garage traffic
                      control markings.
                    </p>
                  </div>
                  <div className="border border-white/10 bg-[#0B0B0D] p-6 hover:-translate-y-1 hover:border-white/45 transition duration-500">
                    <h3 className="font-bold text-white text-sm mb-3">
                      Cabinet & Fine Millwork Spraying
                    </h3>
                    <p className="text-sm text-[#b9b2a6]">
                      Meticulous multi-stage prep, grain stabilization,
                      industrial primers, and dust-controlled airless spray
                      coatings for high-end wood upgrades.
                    </p>
                  </div>
                  <div className="border border-white/10 bg-[#0B0B0D] p-6 hover:-translate-y-1 hover:border-white/45 transition duration-500">
                    <h3 className="font-bold text-white text-sm mb-3">
                      Precision Prep & Trim Finish
                    </h3>
                    <p className="text-sm text-[#b9b2a6]">
                      Sanding, dust extraction, caulking, premium primer coat
                      application, and high-performance trade-built neatness for
                      longevity.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-white text-xs mb-1">
                        Journeyworker Apprenticeship Foundation
                      </h3>
                      <p className="text-sm text-[#b9b2a6]">
                        Led by Anthony Briseno, a tradesman who completed a
                        comprehensive Minnesota Journeyworker Painter &
                        Decorator apprenticeship.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-white text-xs mb-1">
                        Thorough Surface Prep Protocol
                      </h3>
                      <p className="text-sm text-[#b9b2a6]">
                        Meticulous cleaning, scraping, deep sanding, and primer
                        stabilization. We prioritize bond-quality and neatness
                        over fast, cheap shortcuts.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-white text-xs mb-1">
                        Owner-Operated Trade Execution
                      </h3>
                      <p className="text-sm text-[#b9b2a6]">
                        Direct trade oversight on every commercial project,
                        ensuring transparent communication, project timeline
                        tracking, and zero sub-contractor layers.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#b9b2a6] mt-1">
                        Fully insured by Acuity Insurance ($1M/$2M Commercial
                        General Liability, Commercial Auto, and Inland Marine).
                        Policy validation records available.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#b9b2a6] mt-1">
                        Exempt owner-operator status under Minnesota Statute
                        176.041 (zero payroll). Signed attestation forms are
                        maintained, and certificates of compliance are provided
                        upon request to commercial and government partners.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-8 lg:border-l lg:border-white/10 lg:pl-10">
              ...
              <div className="relative overflow-hidden border border-white/10 bg-[#0B0B0D]/90 p-6 md:p-8 backdrop-blur-sm space-y-6">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div className="border border-white/5 bg-white/[0.02] p-3">
                    ...
                    <p className="text-xs font-bold text-white mt-1">
                      Registered Minnesota Specialty Contractor (Painting)
                    </p>
                  </div>
                  ...
                  <div className="border border-white/10 bg-white/5 p-3">
                    ...
                    <p className="text-xs font-bold text-white mt-1">
                      Registration package in preparation
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden border border-white/10 bg-[#0B0B0D] p-6 space-y-4">
                ...
                <div className="relative z-10 space-y-3">
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="text-[#b9b2a6] font-bold">
              ...
              <div className="border border-white/10 bg-[#0B0B0D] p-6 space-y-2 text-xs">
                ...
                <p className="text-[#b9b2a6] leading-relaxed">
                  Headquartered in the Twin Cities Metro, MN. Proudly providing
                  commercial painting, pavement marking, and cabinet spraying
