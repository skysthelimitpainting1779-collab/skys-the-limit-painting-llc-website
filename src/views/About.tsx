        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn delay={0.2} direction="left">
            <div>
              ...
              <div className="mt-12">
                <Link href="/contact" className="inline-flex items-center gap-2 bg-[#f0c067] hover:bg-white text-[#050505] px-8 py-4 rounded-none font-black transition-colors uppercase tracking-widest text-sm cursor-pointer">
