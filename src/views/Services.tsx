  ...
  return (
    <div className="group relative rounded-sm overflow-hidden border border-white/10 shadow-sm flex flex-col h-full bg-black-charcoal">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <Link href={link || "/services"} className="inline-flex items-center gap-2 text-orange-safety font-bold text-sm tracking-widest uppercase hover:text-orange-deep transition-colors mt-auto border border-orange-safety/30 px-6 py-3 rounded-sm justify-center group-hover:border-orange-safety">
