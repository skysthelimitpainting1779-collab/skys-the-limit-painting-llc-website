    ...
    <PageTransition>
      ...
      <section className="relative overflow-hidden bg-[#070706] px-6 py-24">
        ...
        <div className="relative mx-auto max-w-4xl text-center md:text-left z-10">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-gray-300 mx-auto md:mx-0">
            The link may be old, moved, or typed incorrectly. Don't worry, you
            can start fresh from the homepage, use the room cost calculator, or
            submit a request directly below.
          </p>
          <div className="mt-10 flex flex-col justify-center md:justify-start gap-3 sm:flex-row">
            <Link
              href="/"
              className="inline-flex items-center justify-center gap-2 bg-white hover:bg-white text-[#15110a] px-7 py-4 text-sm font-black transition-colors"
            >
              <Home size={18} />
              Back to Home
            </Link>
            <Link
              href="/estimate"
              className="inline-flex items-center justify-center gap-2 border border-[#d8c7aa]/16 bg-[#11100d]/90 px-7 py-4 text-sm font-black text-white transition-colors hover:border-white/45 hover:text-white"
            >
              <Calculator size={18} />
      ...
      <section className="bg-[#11100d] py-12 px-6 border-t border-[#d8c7aa]/16">
        <div className="mx-auto max-w-4xl">
          <p className="text-xs font-semibold text-[#c9c1b4] mb-6">
            Or navigate our primary painting sectors:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              href="/residential"
              className="flex items-center gap-4 p-4 border border-[#d8c7aa]/16 bg-[#070706]/60 hover:border-white/45 transition duration-500 hover:-translate-y-0.5 group "
            >
              <span className="grid h-12 w-12 place-items-center border border-[#d8c7aa]/20 bg-[#11100d] text-white">
                <PaintRoller size={20} />
              </span>
              <div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
            <div className="lg:col-span-4">
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight">
                Request an estimate right here.
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-[#4c453d]">
                If you were looking for an estimate form, you don't need to
                navigate further. Describe your project surfaces, timeline, and
