        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 hidden md:block">
            <FadeIn delay={0.2} direction="left">
               <img src="/images/services/commercial/sky-work-08-finished-commercial.webp" alt="Finished Commercial Interior" className="rounded-none border border-white/20 shadow-2xl w-full rotate-1" />
            </FadeIn>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-black-charcoal px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <FadeIn delay={0.1}>
                <div className="bg-black-primary/50 p-4 border border-white/10 rounded-none">
                  <h3 className="text-sm font-black uppercase tracking-widest text-white mb-4">Interactive Proof // Commercial Metal Prep vs Finished Office Space</h3>
                  <BeforeAfterSlider 
                    beforeImage="/images/site/iphone-commercial-door-frame.webp" 
                    afterImage="/images/services/commercial/sky-work-08-finished-commercial.webp"
                    beforeLabel="Commercial Metal Prep"
                    afterLabel="Finished Commercial Space"
                  />
                </div>
              </FadeIn>
            </div>
            <div>
              <FadeIn delay={0.2}>
                <div className="group rounded-none overflow-hidden border border-white/10 relative h-[382px]">
