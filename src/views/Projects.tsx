...
const CaseStudyCard = ({
  ...
  <div className="bg-[#0B0B0D] rounded-none overflow-hidden border border-white/10  flex flex-col group h-full mb-12 transition duration-500 hover:border-white/30">
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-10 pointer-events-none">
        <span className="bg-white text-[#050505] text-xs font-black px-3 py-1 rounded-none ">
          {type}
        </span>
      </div>
    </div>
    <div className="p-8 flex flex-col flex-1">
      <h3 className="text-xl font-display font-black text-white mb-6 group-hover:text-gray-300 transition-colors">
        {type}
      </h3>
      <div className="space-y-6 mb-8 flex-grow">
        <div>
          <h4 className="text-gray-400 text-xs font-bold mb-2 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-red-500"></span> The
            Challenge
          </h4>
        ...
        <div>
          <h4 className="text-gray-400 text-xs font-bold mb-3 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-yellow-500"></span> The
            Prep
          </h4>
...
export default async function ProjectsPage() {
  ...
  try {
    ...
    console.error(
      `Portfolio DB fetch failed (${message}), using static fallback.`
    );
  }
  ...
  const fallbackProjects = [
    {
      ...
      problem:
        'Client needed a darker, more finished look for a storefront interior while working with the existing ceiling grid.',
      prep: [
        'Grid cleaning',
        'Floor protection',
        'Masking fixtures',
      ...
      result:
        'Darker, cleaner commercial interior with a more complete presentation for customers and staff.',
      beforeImage: '/brand/generated/sky-owner-proof.webp',
      afterImage:
        '/images/services/commercial/sky-work-08-finished-commercial.webp',
    },
    {
      type: 'Interior Residential Repaint',
      location: 'Twin Cities Metro',
      problem:
        'Bedroom walls, trim, and doors had visible wear, dated colors, and stains that needed careful prep before finish paint.',
      prep: [
        'Drywall patching',
      ...
      result:
        'A cleaner, more current bedroom finish with sharper lines, stronger coverage, and a calmer finished feel.',
      beforeImage:
        '/images/services/interior/sky-work-01-finished-kitchen.webp',
      afterImage:
    ...
    },
    {
      ...
      problem:
        'Faded lot markings made parking flow harder to read and weakened the first impression of the property.',
      prep: [
        'Power washing',
        'Debris clearing',
        'Chalk lining',
      ...
      result:
        "Clearer, brighter parking lot markings that improve visibility, traffic flow, and the property's arrival experience.",
    ...
    },
    {
      ...
      problem:
        'Living room walls and trim needing an update to brighten the space after years of fading and minor structural settling.',
      prep: [
        'Caulking baseboards',
        'Putty filling',
        'Spot priming',
      ...
      result:
        'A fresh, clean finish that brightens the room and gives the trim and walls a more finished look.',
      ...
      <main className="animate-premium-fade-in">
        ...
        <section className="relative overflow-hidden bg-[#050505] py-24 px-6 border-b border-white/10">
          <ResponsiveImage
            ...
            alt="Sky's the Limit Painting LLC premium work proof"
            width={1920}
            height={1080}
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-300 max-w-xl">
                Take a look at some of our recent verifiable interior, exterior,
                and commercial painting projects across the Twin Cities.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto bg-[#0B0B0D] border border-white/10 rounded-none p-8 md:p-12 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                We're ready to put the same level of care into your next
                project. Contact us today for a free estimate.
              </p>
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 bg-white hover:bg-gray-200 text-[#050505] px-8 py-4 rounded-none font-black transition-colors text-sm cursor-pointer"
              >
