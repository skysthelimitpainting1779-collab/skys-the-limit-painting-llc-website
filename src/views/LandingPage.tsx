...
export default function LandingPageRoute({
  ...
  const pageData =
    initialPageData ||
    landingPageByKindAndSlug(kind, typeof slug === 'string' ? slug : undefined);
  ...
  const siblings =
    page.kind === 'area' ? areaLandingPages : serviceLandingPages;
  ...
  const relatedCards = [
    ...
    ...siblings.filter(
      (sibling) =>
        ...
        !relatedPages.some((related) => related!.slug === sibling.slug)
    ),
  ].slice(0, 4);
      ...
      <section className="relative overflow-hidden bg-[#070706] px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12 lg:items-end">
          <FadeIn className="w-full overflow-hidden lg:col-span-7">
            ...
            <h1 className="max-w-[calc(100vw-2rem)] break-words text-[2rem] font-black leading-[1.02] text-white sm:max-w-5xl sm:text-5xl md:text-7xl">
              {page.title}
            </h1>
            <p className="mt-7 max-w-[calc(100vw-2rem)] text-base leading-relaxed text-[#e7dfd2] sm:max-w-3xl md:text-xl">
              {page.headline}
            </p>
          ...
          >
            <div className="w-full overflow-hidden border border-[#d8c7aa]/18 bg-[#11100d]/86 p-6 backdrop-blur">
              ...
              <p className="mt-5 text-base leading-relaxed text-[#e7dfd2]">
                {page.description}
              </p>
                ...
                {page.proof.map((item) => (
                  ...
                  >
                    <CheckCircle2
                      ...
                      size={18}
                    />
                    <span className="min-w-0 break-words text-base font-medium text-white">
                      {item}
                    </span>
                  </div>
                ))}
      ...
      <section className="bg-[#e6dfd2] px-4 py-20 text-[#171512] sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12">
          <FadeIn className="lg:col-span-4">
            ...
            <h2 className="mt-5 break-words text-3xl font-black leading-tight sm:text-4xl md:text-5xl">
              A focused page for a real buyer question.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#4c453d]">
              Start with the kind of work, where it is, what surface needs
              attention, and what proof or timeline matters before the first
              call.
            </p>
            {page.kind === 'area' &&
              page.neighborhoods &&
              page.neighborhoods.length > 0 && (
                <div className="mt-8 border-t border-[#8b4d20]/20 pt-6">
                  <p className="text-xs font-semibold text-[#8b4d20]">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {page.neighborhoods.map((neighborhood) => (
                      <span
                        key={neighborhood}
                        className="bg-[#171512]/10 px-3 py-1.5 text-xs font-semibold text-[#171512]"
                      >
                        {neighborhood}
                      </span>
                    ))}
            ...
            {page.scope.map((item, index) => (
              <FadeIn key={item} delay={0.04 * index}>
                <div className="flex min-h-[112px] gap-4 border-l border-[#8b4d20]/35 bg-[#f5f0e7] p-5">
                  ...
                  <p className="text-base font-black leading-snug text-[#171512]">
                    {item}
                  </p>
                </div>
              </FadeIn>
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12 lg:items-start">
          <FadeIn className="lg:sticky lg:top-36 lg:col-span-5">
            ...
            <h2 className="mt-5 text-4xl font-black leading-tight text-white md:text-6xl">
              Clear steps before anyone starts painting.
            </h2>
          </FadeIn>
              ...
              <FadeIn key={step.title} delay={0.08 * index}>
                <article className="grid overflow-hidden border border-white/10 bg-[#11100d] md:grid-cols-12">
                  ...
                  <div className="p-7 md:col-span-7">
                    ...
                    <p className="mt-4 text-base leading-relaxed text-[#c9c1b4]">
                      {step.body}
                    </p>
                  </div>
                </article>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
          <FadeIn className="lg:col-span-5">
            ...
            <h2 className="mt-5 text-4xl font-black leading-tight md:text-5xl">
              Send photos, location, timeline, and the surface story.
            </h2>
          </FadeIn>
              ...
              {[
                {
                  icon: Camera,
                  title: 'Photo link',
                  body: 'Add a Google Drive, iCloud, Dropbox, or public album link in the form.',
                },
                {
                  icon: Route,
                  title: 'Service lane',
                  body: `This page routes into the ${page.market.toLowerCase()} estimate path.`,
                },
                {
                  icon: ClipboardCheck,
                  title: 'Clear next step',
                  body: 'Anthony gets the project details in a structured format instead of a vague callback request.',
                },
              ].map((card) => (
                <IconFeatureCard
                  key={card.title}
          ...
          <div className="p-7 md:p-10 lg:col-span-7 lg:p-12">
            <FadeIn>
              ...
              <h2 className="mt-5 text-4xl font-black leading-tight md:text-6xl">
                {page.shortTitle} project details.
              </h2>
              <div className="mt-10">
                <LeadForm
                  source={`${page.title} landing page`}
                  defaultMarket={page.market}
                  compact
                />
              </div>
            </FadeIn>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black text-white md:text-4xl">
                Keep moving through the right lane.
              </h2>
            </div>
            <Link
              href={marketPath[page.market]}
          ...
          <div className="grid gap-4 md:grid-cols-4">
            {relatedCards.map((related) => (
              ...
              >
                <p className="text-xs font-semibold text-[#9fa9a9]">
                  {related.eyebrow}
                </p>
