      ...
      >
        <Card className="h-full overflow-hidden border-zinc-800 bg-black/50 backdrop-blur-md transition-colors hover:bg-black/60">
          <div className="relative aspect-[16/10] w-full overflow-hidden border-b border-zinc-800">
            ...
            <span className="absolute left-5 top-5 bg-[#050505]/75 px-3 py-2 text-sm font-bold text-white backdrop-blur">
              {media.label}
            </span>
          </div>
          ...
          <CardHeader>
            ...
            >
              ...
              <motion.p variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }} className="text-sm font-bold text-zinc-400">{media.accent}</motion.p>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }}>
                <CardTitle className="text-2xl tracking-tight text-white">{market.navLabel}</CardTitle>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }}>
              ...
              <div className="grid gap-3 text-xs sm:grid-cols-2">
                {market.proof.slice(0, 2).map((item) => (
                  <motion.div variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }} key={item} className="flex gap-2 border-t border-zinc-800 pt-3">
                    <CheckCircle2 className="mt-0.5 shrink-0 text-zinc-400" size={14} />
                    <span>{item}</span>
                  </motion.div>
                ))}
              </div>
              <motion.span variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }} className="mt-6 inline-flex items-center gap-3 text-sm font-bold text-white group-hover:text-zinc-300">
...
const TrustPillar = ({ pillar, index }: { pillar: (typeof trustPillars)[number]; index: number; key?: Key }) => {
  ...
  return (
    <FadeIn delay={0.06 * index}>
      <div className="flex h-full flex-col justify-start border-t border-zinc-800 pt-8 transition-colors hover:border-zinc-500" onMouseEnter={() => trackEvent('proof_block_view', { title: pillar.title })}>
        <Icon className="mb-6 text-white" size={28} strokeWidth={1.5} />
        <h3 className="text-lg font-black leading-tight text-white">{pillar.title}</h3>
        <p className="mt-3 max-w-[65ch] text-base leading-relaxed text-zinc-400">{pillar.body}</p>
      </div>
    </FadeIn>
  );
};
...
const ProcessStep = ({ step, title, body }: { step: string; title: string; body: string }) => (
  <div className="relative py-10 pl-16 border-t border-zinc-800/60">
    <span
      aria-hidden="true"
    ...
    <span className="absolute left-0 top-10 text-xs font-bold tracking-[0.2em] text-zinc-600 uppercase">{step}</span>
    <h3 className="text-2xl font-black leading-tight text-white">{title}</h3>
    <p className="mt-3 max-w-[65ch] text-base leading-relaxed text-zinc-400">{body}</p>
  </div>
);
    ...
    <>
      <section className="relative min-h-[calc(100svh-116px)] overflow-hidden bg-[#070706]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100svh-116px)] max-w-7xl flex-col justify-between px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          <FadeIn className="w-full pt-6 md:pt-12">
            <p className="mb-7 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">
            ...
            <p className="mt-7 max-w-[65ch] text-base leading-relaxed text-[#e7dfd2] sm:text-lg">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <MagneticButton pullFactor={0.35}>
                <Link
                  ...
                  className="group inline-flex items-center gap-3 bg-white pl-7 pr-2 py-2 text-base font-bold text-[#15110a] transition-colors duration-300 hover:bg-gray-100"
                >
                  Get My Price Range
              ...
              <Link href="/contact" onClick={() => trackEvent('hero_cta_click', { label: 'Book Walkthrough', source: 'home_hero' })} className="inline-flex items-center justify-center gap-2 bg-[#111] px-7 py-4 text-base font-bold text-white transition-colors hover:text-gray-300">
                Book a Site Walkthrough
              </Link>
              <a href="tel:+16514104196" onClick={() => trackEvent('call_click', { source: 'home_hero' })} className="inline-flex items-center justify-center gap-2 bg-[#111] px-7 py-4 text-base font-bold text-white transition-colors hover:text-gray-300">
                <Phone size={18} /> Call or Text Anthony
              </a>
            </div>
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-bold uppercase tracking-[0.15em] text-zinc-500">
          ...
          <FadeIn delay={0.12} className="mt-16">
            <div className="grid gap-8 border-t border-[#d8c7aa]/20 pt-10 md:grid-cols-3">
              {conversionSteps.map((item) => (
                <div key={item.step} className="flex flex-col">
                  <p className="text-sm font-bold text-zinc-500">{item.step} / Customer path</p>
                  <h2 className="mt-3 text-xl font-black leading-tight text-white">{item.title}</h2>
                  <p className="mt-3 max-w-[65ch] text-base leading-relaxed text-zinc-300">{item.body}</p>
                </div>
              ))}
            </div>
          </FadeIn>
      ...
      />
      <section className="border-t border-white/[0.05] bg-[#050505] px-4 py-24 text-white sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12 lg:items-end">
          <FadeIn className="lg:col-span-7">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">The standard</p>
      ...
      <section className="relative overflow-hidden bg-[#11100d] px-4 py-24 text-white sm:px-6 lg:px-8">
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
          ...
          <FadeIn delay={0.1} className="lg:col-span-7">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">The difference</p>
            <h2 className="text-4xl font-black leading-tight md:text-6xl">
              90% of a flawless paint job happens before we open a can.
            </h2>
            <p className="mt-6 max-w-[65ch] text-lg leading-relaxed text-[#c9c1b4]">
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-3">
              {[
                ...
                return (
                  <div key={title as string} className="flex flex-col border-t border-zinc-800 pt-6">
                    ...
                    <div>
                      <ProofIcon className="mb-4 text-white" size={24} strokeWidth={1.5} />
          ...
          <FadeIn>
            <div className="mb-14 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-end">
              <div className="lg:col-span-7">
                <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">Before &amp; after</p>
      ...
      <section id="markets" className="relative overflow-hidden bg-[#080807] px-4 py-24 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-7xl">
          <FadeIn>
            <div className="mb-14 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-end">
              <div className="lg:col-span-7">
                <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">Who we serve</p>
                <h2 className="text-4xl font-black leading-tight text-white md:text-6xl">
      ...
      <section className="relative overflow-hidden border-y border-white/10 bg-[#050505] px-4 py-24 sm:px-6 lg:px-8">
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12">
          <FadeIn className="lg:col-span-4">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">Credentials</p>
            <h2 className="text-4xl font-black leading-tight text-white md:text-5xl">12 years. 340 projects. One owner on every job.</h2>
            <p className="mt-5 max-w-[65ch] text-base leading-relaxed text-[#b9b2a6]">
      ...
      <section className="bg-[#080807] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 lg:grid-cols-12 lg:items-start">
          <FadeIn className="lg:sticky lg:top-36 lg:col-span-5">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">The process</p>
            <h2 className="text-4xl font-black leading-tight text-white md:text-6xl">
      ...
      <section className="relative overflow-hidden bg-[#182023] px-4 py-24 text-white sm:px-6 lg:px-8">
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          <FadeIn className="lg:col-span-6">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-[#dce5e4]/50">Public sector</p>
            <h2 className="text-4xl font-black leading-tight md:text-6xl">
        ...
        <div className="relative mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-8 md:grid-cols-3">
          {[
            ...
            return (
              <FadeIn key={title as string}>
                <div className="flex flex-col border-t border-[#dce5e4]/20 pt-8">
                  <ReadinessIcon className="mb-8 text-white" size={30} strokeWidth={1.5} />
                  <h3 className="text-2xl font-black leading-tight text-white">{title as string}</h3>
                  <p className="mt-4 max-w-[65ch] text-base leading-relaxed text-[#cbd4d3]">{body as string}</p>
                </div>
              </FadeIn>
            );
          })}
      ...
      <section className="border-t border-white/10 bg-[#050505] px-4 py-24 text-white sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 overflow-hidden bg-[#0B0B0D] lg:grid-cols-12">
          ...
          <div className="p-10 lg:col-span-7 lg:p-12 bg-[#0B0B0D]">
            <FadeIn>
              <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">Get started</p>
              <h2 className="text-4xl font-black leading-tight text-white md:text-6xl">
